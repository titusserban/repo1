...
a = input('apasa tasta r') #rawinput pentru 2.7
print(a)
print("elevul 'x' nu si-a realizat tema")
print('elevul "x" nu si-a realizat tema')
#print("elevul "x" nu si-a realizat tema") nu functioneaza din cauza ghilimelelor
print("Ana are mere \n Ion")
print("""
\tAna are mere
Iulia are pere
...
#nu putem incepe variabilele cu cifre ==> ex: 1variabila; cel mai bine se scriu cu underscore ==> ex: variable_number_1
