...
def ascunderea_literelor(orice_cuvant: list) -> list:
    ...
    :param orice_cuvant: se ia ca input orice cuvant
...
while not joc_terminat:
    ...
    # Daca jucatorul nu a mai folosit litera, o introducem in lista de caractere:
    if litera_ghicita not in caractere_deja_incercate:
        caractere_deja_incercate.append(litera_ghicita)
